...
function Portfolio() {
  ...
  return (
    <section className="relative py-20 md:py-32 bg-gray-850 transition-all duration-700">
      <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-b from-gray-850 via-gray-850 to-gray-850"></div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-gray-800 via-gray-830 to-gray-850"></div>
      
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-12 md:mb-20">
          <div className="inline-flex items-center gap-3 bg-gray-700 border border-gray-600 rounded-full px-4 md:px-6 py-2 mb-6">
            <div className={`w-2 h-2 rounded-full ${portfolioData.length > 0 ? 'bg-green-400 animate-pulse' : 'bg-red-400'}`}></div>
            <span className="text-xs md:text-sm text-gray-300 font-medium">{portfolioData.length > 0 ? 'Live Market Data' : 'Market Data Unavailable'}</span>
          </div>
