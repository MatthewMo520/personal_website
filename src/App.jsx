...
function Home() {
  return (
    <div className="app flex flex-col justify-center min-h-screen bg-gray-100">
      ...
      <main className="px-8">
        <Element name="about-me" id="about-me" className="mb-8">
        ...
        <Element name="market" id="market" className="mb-8">
          <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <Element name="portfolio" id="portfolio" className="mb-8">
          <section className="bg-white p-6 rounded-lg shadow-md">
        ...
        <Element name="contact-me" id="contact-me" className="mb-8">
          <section className="bg-white p-6 rounded-lg shadow-md">
